...
export const PORTFOLIO_DATA: PortfolioData = {
  profile: {
    ...
    tagline:
      "Translating complex operations into fast, accessible web products with React.js, Next.js, and modern full-stack architectures.",
    ...
    education: [
      {
        ...
        period: "2020 – 2023",
        details:
          "Undergraduate coursework focused on Data Structures, Algorithms, Software Engineering, Database Systems, and Object-Oriented Programming.",
      },
      {
        id: "edu-2",
        ...
        period: "2018 – 2019",
        details:
          "Higher secondary education curriculum with concentration in Mathematics, Physics, and ICT.",
      },
      {
        id: "edu-3",
        ...
        period: "Completed",
        details:
          "Comprehensive professional full-stack training covering Advanced React, Next.js, Node.js, Express, MongoDB, TypeScript, and Redux Toolkit.",
      },
    ],
    spokenLanguages: [
  ...
  stats: [
    { label: "Years in Production", value: 2, suffix: "+", change: "May 2024 – Present" },
    {
      ...
      value: 123,
      suffix: "",
      change: "Active open-source & codebases",
    },
    {
      label: "Editor Themes Shipped",
      value: 11,
      suffix: "",
      change: "OpenPalette developer suite",
    },
    {
      label: "Icons & Folder Assets",
      value: 390,
      suffix: "+",
      change: "Packaged developer tooling",
    },
    {
      label: "UI Accessibility & a11y",
      value: 100,
      suffix: "%",
      change: "Cross-device responsive perfection",
    },
    {
      label: "State Sync & Predictability",
      value: 99.9,
      suffix: "%",
      decimals: 1,
      change: "Redux Toolkit & RTK Query",
    },
  ],
  ...
  projects: [
    {
      ...
      description:
        "A full-stack e-commerce platform with real-time inventory management, multi-currency checkout, live order tracking, seller analytics, and an integrated Google Gemini AI shopping advisor.",
      challenge:
        "Handling real-time stock synchronization, multi-tier permissions (Customer/Seller/Admin), secure multi-currency checkout, and personalized catalog discovery.",
      solution:
        "Built with Next.js 15 App Router, React 19, TypeScript, Prisma ORM, PostgreSQL, Redis caching, Socket.io webhooks, and Google Gemini AI API.",
      impact: [
    ...
    },
    {
      ...
      category: "Full-Stack Apps",
      description:
        "A production-grade IoT platform for streaming real-time sensor telemetry, historical data visualization, remote device control, and automated alert monitoring.",
      challenge:
        "Handling concurrent streaming data from 50+ IoT sensors requires low-latency WebSockets, time-series historical data storage, and instant visual telemetry alerts.",
      solution:
        "Engineered with Next.js, React, TypeScript, WebSocket telemetry streaming, Prisma ORM, PostgreSQL, TanStack Query, NextAuth, and Zustand.",
      impact: [
    ...
    },
    {
      ...
      category: "Full-Stack Apps",
      description:
        "A full-stack multi-vendor commerce platform featuring distinct user workflows for buyers, sellers, and administrators with role-based access control, real-time cart sync, wallet checkout, and an in-app AI assistant.",
      challenge:
        "Coordinating multi-role permissions, complex shopping cart transactions, wallet checkouts, and real-time seller analytics in a single unified architecture.",
      solution:
        "Built with React 19, Express 5, MongoDB, and TanStack Query. Implemented JWT authentication with RBAC, modular API controllers, Zustand client stores, and Dockerized microservices.",
      impact: [
    ...
    },
    {
      ...
      description:
        "A production-ready modern fitness and gym web application built for lightning-fast Core Web Vitals, dynamic program schedules, and seamless client interactions.",
      challenge:
        "Achieving sub-second Largest Contentful Paint (LCP) and high SEO ranking while handling rich media, trainer rosters, and membership pricing plans.",
      solution:
        "Developed with Next.js 16 App Router using modular component architecture, server-side rendering (SSR), lazy image loading, and fluid entry animations with Motion.",
      impact: [
    ...
    },
    {
      ...
      description:
        "An enterprise-grade frontend dashboard designed for real-time business monitoring, featuring modular panel layouts, dynamic route filtering, and geospatial mapping.",
      challenge:
        "Rendering multiple high-density data visualizations and map markers simultaneously without frame drops or memory leaks.",
      solution:
        "Built in React with Redux centralized state management, ECharts rendering pipelines, and Google Maps API integration for interactive geospatial exploration.",
      impact: [
    ...
    },
    {
      ...
      description:
        "An open-source developer productivity suite packaging 11 meticulously crafted editor color palettes, 300+ file icons, 90+ folder icons, and multi-language snippets.",
      challenge:
        "Maintaining visual consistency across hundreds of language syntax tokens and file extension icons with automated version releases.",
      solution:
        "Engineered using TypeScript and the VS Code Extension API with automated GitHub Actions workflows, semantic release standard versioning, and JSON token mapping.",
      impact: [
  ...
  skillCategories: [
    {
      ...
      description:
        "Component architecture, scalable state management, and modern rendering patterns.",
      iconName: "Layout",
      skills: [
        {
          name: "React.js",
          ...
          description: "Hooks, Context API, component composition, custom state patterns",
          featured: true,
        },
        {
          name: "Next.js",
          level: 92,
          experienceYears: "2+ yrs",
          description: "App Router, SSR, SSG, dynamic routing, SEO optimization",
          featured: true,
        },
        {
          name: "TypeScript",
          level: 90,
          experienceYears: "2+ yrs",
          description: "Strong typing, interfaces, generics, type-safe API contracts",
          featured: true,
        },
        {
          name: "JavaScript (ES6+)",
          ...
          description: "Async/await, closures, event loop, DOM manipulation",
          featured: true,
        },
        {
          ...
          level: 94,
          experienceYears: "2+ yrs",
          description: "Centralized store, slices, automated caching, normalized state",
          featured: true,
        },
        {
          name: "TanStack Query",
          ...
          description: "Server state caching, optimistic updates, pagination",
        },
      ],
    },
    {
      ...
      skills: [
        {
          ...
          level: 96,
          experienceYears: "2+ yrs",
          description: "Custom utility configurations, dark mode, responsive layouts",
          featured: true,
        },
        {
          ...
          level: 90,
          experienceYears: "2+ yrs",
          description: "Enterprise component libraries, form systems, data tables",
          featured: true,
        },
        {
          ...
          level: 95,
          experienceYears: "3+ yrs",
          description: "Semantic markup, modern CSS grid/flexbox, transitions",
        },
        {
          name: "ECharts & Data Visualization",
          level: 88,
          experienceYears: "1.5+ yrs",
          description: "Interactive dashboards, charts, graphs, map analytics",
          featured: true,
        },
        {
          ...
          level: 86,
          experienceYears: "1.5+ yrs",
          description: "Fluid UI transitions, stagger animations, gesture handling",
        },
        {
          name: "Google Maps API",
          level: 85,
          experienceYears: "1.5+ yrs",
          description: "Geospatial markers, routing, custom map layers",
        },
      ],
    },
    {
      ...
      description:
        "RESTful services, authentication security, schema modeling, and modular backends.",
      iconName: "Database",
      skills: [
        {
          ...
          level: 90,
          experienceYears: "2+ yrs",
          description: "RESTful API services, middleware pipelines, error handling",
          featured: true,
        },
        {
          name: "NestJS",
          ...
          description: "Modular architecture, dependency injection, TypeScript backend",
          featured: true,
        },
        {
        ...
        },
        {
          ...
          level: 92,
          experienceYears: "2+ yrs",
          description: "Role-based access control, token refresh, secure sessions",
          featured: true,
        },
        {
          name: "REST APIs & Zod",
          level: 90,
          experienceYears: "2+ yrs",
          description: "API contract design, payload validation, error contracts",
        },
        {
          name: "PostgreSQL & MySQL",
          level: 80,
          experienceYears: "1+ yrs",
          description: "Relational schemas, queries, foreign keys, migrations",
        },
        {
          name: "WebSockets & GraphQL (Basic)",
          level: 78,
          experienceYears: "1+ yrs",
          description: "Real-time messaging, schema definitions",
        },
      ],
    },
    {
      ...
      skills: [
        {
          ...
          level: 95,
          experienceYears: "2+ yrs",
          description: "Branching strategies, PR reviews, merge resolution",
          featured: true,
        },
        {
          ...
          level: 86,
          experienceYears: "1.5+ yrs",
          description: "Automated testing, linting, release workflows",
          featured: true,
        },
        {
          name: "Vercel & Netlify",
          level: 92,
          experienceYears: "2+ yrs",
          description: "Serverless deployments, environment configurations, preview branches",
          featured: true,
        },
        {
          ...
          level: 86,
          experienceYears: "1.5+ yrs",
          description: "Authentication, Firestore, real-time database, storage",
        },
        {
          name: "Postman",
          level: 94,
          experienceYears: "2+ yrs",
          description: "API testing, collections, environment variables, documentation",
        },
        {
          name: "Docker (Basic)",
          level: 80,
          experienceYears: "1+ yrs",
          description: "Containerized development, Dockerfiles, compose setups",
        },
      ],
    },
  ],
  ...
  experience: [
    {
      ...
      summary:
        "Designed and delivered responsive enterprise dashboards, operational workflow systems, inventory management, product tracking, and reporting platforms across multi-client environments.",
      highlights: [
  ...
  publications: [
    {
      ...
      readTime: "8 min read",
      abstract:
        "A comprehensive technical guide to structuring enterprise React applications with normalized store slices, automated cache tag invalidation, and optimistic updates to eliminate redundant network roundtrips.",
    ...
    },
    {
      ...
      readTime: "6 min read",
      abstract:
        "Practical strategies for optimizing LCP, CLS, and INP metrics in production Next.js applications through intelligent asset loading, font streaming, and modular chunk splitting.",
    ...
    },
    {
      ...
      abstract:
        "Implementing robust multi-tenant authentication and authorization flows with JWT, refresh token rotation, and declarative permission guards in React and Express.js.",
  ...
  testimonials: [
    {
      id: "test-1",
      quote:
        "MD Razikul Islam Joni is an exceptionally dedicated frontend developer who quickly translates complex business operations into intuitive, polished dashboard interfaces. His expertise in Redux Toolkit and REST API integrations significantly accelerated our product timelines.",
    ...
    },
    {
      id: "test-2",
      quote:
        "Razikul has a sharp eye for detail, clean code architecture, and UI performance. His ability to build responsive, accessible interfaces and seamlessly collaborate with backend teams made him a vital contributor to our engineering workflows.",
    ...
    },
    {
      id: "test-3",
      quote:
        "An outstanding developer with a strong passion for continuous learning. Razikul's mastery of React, Next.js, and modern state management is evident in every feature and open-source project he ships.",
      author: "Tanvir Ahmed",
