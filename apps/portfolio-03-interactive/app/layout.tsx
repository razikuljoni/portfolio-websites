...
export const metadata: Metadata = {
  ...
  description:
    "Personal portfolio of MD Razikul Islam Joni — Full Stack Developer with 2+ years of professional experience delivering scalable, high-performance web apps using React.js, Next.js, Redux Toolkit, and Node.js.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Product-minded full-stack developer specializing in React.js, Next.js, TypeScript, Redux Toolkit, and enterprise dashboards.",
    type: "website",
    locale: "en_US",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" data-theme="dark" suppressHydrationWarning>
      <body
        className="antialiased selection:bg-[#b87333]/30 selection:text-[#f5f0e8]"
