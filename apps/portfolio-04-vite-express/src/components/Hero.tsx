...
export const Hero: React.FC<HeroProps> = ({ onExploreArchitecture, onExploreTechStack }) => {
  const [activeScenario, setActiveScenario] = useState<"shoppershala" | "hawkeyes" | "forge">(
    "shoppershala"
  );
  ...
  const scenarios = {
    shoppershala: {
      ...
      description:
        "Dedicated Buyer, Seller, and Admin journeys with JWT RBAC, wallet checkout, seller analytics, and an in-app AI copilot.",
    ...
    hawkeyes: {
      ...
      description:
        "Responsive operational management systems for inventory tracking, product lifecycle, and field-work assignment tracking at HawkEyes.",
    ...
    forge: {
      ...
      description:
        "Performance-first Next.js App Router platform with modular component architecture, server rendering, lazy loading, and Motion.",
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-neutral-100 leading-[1.12]">
              Building{" "}
              <span className="text-white underline decoration-amber-400/60 decoration-2 underline-offset-4">
                High-Performance
              </span>{" "}
              Web Products & Scalable Dashboards
            </h1>

            {/* Subtext */}
            <p className="text-base sm:text-lg text-neutral-300 leading-relaxed max-w-2xl font-normal">
              Hi, I'm <strong className="text-white font-semibold">MD Razikul Islam Joni</strong>.
              Product-minded Full Stack Developer with 2+ years of professional experience building
              responsive enterprise dashboards, operational workflow systems, and high-conversion
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
              <div className="p-3 rounded-xl bg-neutral-900/60 border border-neutral-800/80">
                <div className="text-xl font-bold text-amber-400 font-mono">
                  {PERSONAL_INFO.stats.yearsOfExp} Yrs
                </div>
              ...
              <div className="p-3 rounded-xl bg-neutral-900/60 border border-neutral-800/80">
                <div className="text-xl font-bold text-emerald-400 font-mono">
                  {PERSONAL_INFO.stats.editorThemesShipped}
                </div>
                <div className="text-xs text-neutral-400 mt-0.5">Themes Shipped</div>
              </div>
              <div className="p-3 rounded-xl bg-neutral-900/60 border border-neutral-800/80">
                <div className="text-xl font-bold text-neutral-100 font-mono">
                  {PERSONAL_INFO.stats.iconsCreated}
                </div>
              ...
              <div className="p-5 space-y-4 font-mono text-xs">
                ...
                <div className="grid grid-cols-3 gap-2 py-1">
                  <div className="p-2.5 rounded-lg bg-neutral-900/90 border border-neutral-800">
                    ...
                    <div className="text-xs font-bold text-neutral-100 mt-0.5 truncate">
                      {current.metric1}
                    </div>
                  </div>
                  <div className="p-2.5 rounded-lg bg-neutral-900/90 border border-neutral-800">
