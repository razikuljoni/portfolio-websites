...
export const PERSONAL_INFO = {
  ...
  skillGroups: {
    ...
    toolsAndAI: [
      "In-App AI Copilot (Gemini API)",
      "VS Code Themes & Extension Tooling (OpenPalette)",
    ],
  },
  stats: {
    yearsOfExp: "2+",
...
export const TECH_SKILLS: TechSkill[] = [
  // Languages & Core
  {
    ...
    iconName: "Code2",
    description:
      "Strict end-to-end type safety, generic utility types, discriminated unions for state management, and schema-driven API contracts.",
...
export const unwrapResponse = <T>(res: ApiResponse<T>): T => {
  ...
  },
  {
    ...
    iconName: "Code2",
    description:
      "Modern asynchronous JavaScript, closures, event loop mechanics, DOM manipulation, functional data transformations, and Web APIs.",
    productionHighlights: [
  ...
  // Frontend & UI
  {
    ...
    iconName: "Layout",
    description:
      "Component architecture, custom hooks, synthetic event handling, render lifecycle optimization, and accessible UI system design.",
    productionHighlights: [
...
export function useOperationalFeed<T>(fetcher: () => Promise<T>, pollMs = 5000) {
  ...
  },
  {
    ...
    iconName: "Globe",
    description:
      "Next.js App Router, Server Components (RSC), SEO-first rendering, streaming UI, image optimization, and Vercel edge deployment.",
    productionHighlights: [
...
export default async function ProgramPage({ params }: { params: { id: string } }) {
  ...
  },
  {
    ...
    iconName: "Workflow",
    description:
      "Predictable state management, normalized caching, optimistic updates, automatic cache invalidation, and RTK Query middleware.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "Zap",
    description:
      "Server state management, background refetching, client store micro-state with Zustand, and query hydration.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "Palette",
    description:
      "Utility-first CSS architecture, responsive design across mobile/tablet/desktop, dark theme design tokens, and clean layout geometry.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "Layout",
    description:
      "Enterprise design system integration, Material UI, Ant Design customization, accessible form controls, and theme overrides.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "BarChart3",
    description:
      "Data-heavy visualizations, multi-series time-series charts, geospatial telemetry mapping, and interactive widget dashboards.",
    productionHighlights: [
    ...
    architecturalPatterns: [
      "Responsive Chart Viewport Observers",
      "Geospatial Marker Clustering",
      "Live Stream Series Appending",
    ],
  },
  ...
  // Backend & APIs
  {
    ...
    iconName: "Server",
    description:
      "Event-driven server runtimes, RESTful API architecture, Express 5 middleware pipelines, error handling, and file streaming.",
    productionHighlights: [
...
export const createProductHandler = async (req: Request, res: Response, next: NextFunction) => {
  ...
  },
  {
    ...
    iconName: "Boxes",
    description:
      "TypeScript-first enterprise backend framework, dependency injection, modular architecture, DTO validation, and decorators.",
    productionHighlights: [
  ...
  },
  {
    ...
    description:
      "Stateless JSON Web Tokens (JWT), refresh token rotation, Role-Based Access Control (RBAC), password hashing with bcrypt, and Zod.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "Radio",
    description:
      "RESTful API contract design, HTTP status standards, real-time bi-directional WebSockets, and event broadcasting.",
    productionHighlights: [
    ...
    architecturalPatterns: [
      ...
      "Heartbeat Connection Reconnection",
    ],
  },
  ...
  // Databases & Cloud
  {
    ...
    iconName: "Database",
    description:
      "Document database modeling, Mongoose schemas, compound indexing, aggregation pipelines, and transactions.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "Database",
    description:
      "Relational data modeling, foreign key constraints, SQL queries, joins, transactions, and basic indexing.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "FolderGit2",
    description:
      "Git branching strategies, continuous integration, GitHub Actions CI/CD workflows, Docker containerization, and automated release tooling.",
    productionHighlights: [
    ...
    architecturalPatterns: [
      "Git Feature Branching Workflows",
  ...
  },
  {
    ...
    iconName: "Network",
    description:
      "Edge hosting, serverless functions, environment configuration, SSL management, preview branches, and API testing with Postman.",
    productionHighlights: [
  ...
  // AI & Developer Tooling
  {
    ...
    iconName: "Sparkles",
    description:
      "In-app AI assistant integration, Gemini API, intelligent catalog search, natural language queries, and contextual prompts.",
    productionHighlights: [
  ...
  },
  {
    ...
    iconName: "Terminal",
    description:
      "VS Code Extension API, TextMate grammar theme tokens, custom file/folder icon themes, and snippet packages.",
    productionHighlights: [
    ...
    architecturalPatterns: [
      ...
      "TextMate Scope Tokenization",
      "File Icon Association Schemes",
    ],
  },
];
...
export const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    tagline:
      "Big-scale e-commerce platform with smart recommendations, real-time inventory, multi-currency checkout, 2FA security, and seller analytics.",
    category: "Full-Stack Commerce",
    clientOrDomain: "E-Commerce & AI Retail Tech",
    year: "2026",
    scale: "Multi-Role • Next.js 15 • React 19 • Gemini AI",
    summary:
      "Architected and built a big-scale full-stack e-commerce platform featuring Google Gemini AI shopping advice, real-time inventory synchronization, 2FA security, multi-currency localization, and seller analytics dashboards.",
    liveUrl: "https://z-shop-online.vercel.app",
    githubUrl: "https://github.com/razikuljoni/z-shop",
    challenge: {
      context:
        "Scaling modern digital storefronts requires real-time stock sync across multiple merchant inventories, instant multi-currency checkout, strict 2FA security, and personalized catalog discovery without performance degradation.",
      painPoints: [
    ...
    architecturalSolution: {
      coreApproach:
        "Engineered a Next.js 15 + React 19 platform backed by PostgreSQL and Prisma ORM. Integrated Google Gemini AI for serverless shopping guidance, Recharts for seller analytics, Socket.io for live order webhooks, and Redis for caching.",
      keyDecisions: [
        {
          decision: "Google Gemini AI Integration with Catalog Grounding",
          rationale:
            "Integrated serverless AI shopping advisor routes that evaluate buyer preferences and return contextual product recommendations.",
          alternativeConsidered:
            "Static keyword search was upgraded with AI natural language understanding.",
        },
        {
          decision: "Multi-Currency & 2FA Security Architecture",
          rationale:
            "Implemented 2FA authentication and multi-currency calculation routines backed by server-side Zod validation envelopes.",
          alternativeConsidered:
            "Client-side currency conversion was rejected to ensure price integrity and tax compliance.",
        },
        {
          decision: "Prisma + Redis Caching for Real-Time Inventory",
          rationale:
            "Cached hot catalog items in Redis while maintaining strict transactional integrity in PostgreSQL via Prisma ORM.",
          alternativeConsidered:
            "Direct un-cached database queries on every page render were replaced.",
        },
      ],
      diagramSteps: [
        {
    ...
    metrics: [
      {
        label: "AI Advisor",
        value: "Gemini API",
        change: "Personalized recommendations",
        isPositive: true,
      },
      {
        label: "Database Sync",
        value: "Sub-10ms",
        change: "Prisma ORM + PostgreSQL",
        isPositive: true,
      },
      {
        label: "Security",
        value: "2FA + Zod",
        change: "100% type-safe validation",
        isPositive: true,
      },
    ],
  ...
  },
  {
    ...
    tagline:
      "Production-grade IoT platform for streaming real-time sensor telemetry, device control, and automation workflows.",
    ...
    summary:
      "Developed a production-grade IoT platform with real-time WebSocket telemetry streaming, remote device command dispatch, historical analytics, and automated alert monitoring.",
    liveUrl: "https://github.com/razikuljoni/SensorGrid",
    githubUrl: "https://github.com/razikuljoni/SensorGrid",
    challenge: {
      context:
        "Industrial sensor networks generate continuous high-frequency telemetry data requiring low-latency WebSockets, zero data loss, time-series storage, and calm alert monitoring.",
      painPoints: [
    ...
    architecturalSolution: {
      coreApproach:
        "Engineered a Next.js + React dashboard with Socket.io WebSockets, Prisma ORM, PostgreSQL, TanStack Query, NextAuth, and Zustand state orchestration.",
      keyDecisions: [
        {
          decision: "WebSocket Telemetry Streaming Protocol",
          rationale:
            "Established persistent Socket.io channels for streaming live sensor telemetry directly to dashboard state.",
          alternativeConsidered:
            "HTTP short polling was replaced to minimize server load and bandwidth.",
        },
        {
          decision: "TanStack Query + Zustand Dual State Architecture",
          rationale:
            "Managed server telemetry queries with TanStack Query and local dashboard UI layout controls with Zustand.",
          alternativeConsidered:
            "Monolithic store was avoided to isolate high-frequency telemetry state.",
        },
      ],
      diagramSteps: [
        {
    ...
    tradeoffs: [
      {
        ...
        mitigation:
          "Implemented automatic fallback to smart long-polling with reconnection backoff.",
      },
    ],
    metrics: [
      {
        ...
        value: "Real-Time",
        change: "Sub-100ms WebSockets",
        isPositive: true,
      },
      {
        label: "Device Metrics",
        value: "50+ Nodes",
        change: "Simultaneous monitoring",
        isPositive: true,
      },
  ...
  },
  {
    ...
    tagline:
      "Multi-role e-commerce platform with JWT RBAC, catalog search, wallet checkout, seller analytics, and an in-app AI assistant.",
    category: "Full-Stack Commerce",
    clientOrDomain: "E-Commerce & Digital Marketplace",
    year: "2025–2026",
    scale: "Multi-Role • Monorepo • React 19 + Express 5",
    summary:
      "Architected and built a full-stack e-commerce monorepo powering distinct buyer, seller, and admin experiences with strict role-based access control, rich catalog filtering, seller revenue analytics, and an integrated AI shopping copilot.",
    liveUrl: "https://github.com/razikuljoni",
    githubUrl: "https://github.com/razikuljoni/Shoppershala",
    challenge: {
      context:
        "Multi-vendor marketplaces require complex role separation: buyers need lightning-fast catalog search and frictionless checkout; sellers need inventory management and real-time revenue analytics; admins need global platform governance.",
      painPoints: [
    ...
    architecturalSolution: {
      coreApproach:
        "Engineered a modern React 19 + Express 5 monorepo backed by MongoDB. Utilized TanStack Query for server state caching, Zustand for lightweight client cart persistence, Zod for end-to-end schema validation, and integrated an AI shopping copilot.",
      keyDecisions: [
        {
          decision: "Zustand + TanStack Query Hybrid State Architecture",
          rationale:
            "Separated persistent client-only state (cart items, local preferences) from server-managed asynchronous state (catalog, orders, inventory) to prevent unnecessary re-renders.",
          alternativeConsidered:
            "Single monolithic global state was rejected due to boilerplate and redundant re-render cascades.",
        },
        {
          decision: "Granular Role-Based Access Control (RBAC) Middleware",
          rationale:
            "Built reusable Express middleware validating JWT tokens and checking exact role capabilities (buyer, seller, admin) before hitting controller logic.",
          alternativeConsidered:
            "Hardcoded controller-level if/else checks were rejected to avoid permission leaks and code duplication.",
        },
        {
          decision: "In-App AI Assistant with Catalog Grounding",
          rationale:
            "Integrated an AI copilot that parses customer intent and suggests products directly from the database catalog with streaming responses.",
          alternativeConsidered:
            "Static keyword search was supplemented with conversational AI for enhanced buyer conversion.",
        },
      ],
      diagramSteps: [
        {
    ...
    tradeoffs: [
      {
        accepted:
          "Zustand localStorage synchronization requires schema versioning on client upgrades",
        mitigation:
          "Implemented client migration checks on application startup to ensure schema compatibility.",
      },
      {
        accepted: "Multi-role JWT tokens require token refresh flows on role promotion",
        mitigation:
          "Configured automated silent token renewal interceptors in Axios/Fetch clients.",
      },
    ],
    metrics: [
      {
        label: "Role Journeys",
        value: "3 Dedicated",
        change: "Buyer, Seller & Admin",
        isPositive: true,
      },
      {
        label: "API Response Time",
        value: "< 45ms",
        change: "Indexed MongoDB queries",
        isPositive: true,
      },
      {
        label: "Checkout Success",
        value: "99.8%",
        change: "Validated wallet & cart flow",
        isPositive: true,
      },
      {
        label: "Codebase Safety",
        value: "100% Type-Safe",
        change: "TypeScript + Zod contracts",
        isPositive: true,
      },
    ],
    techStackIds: [
  ...
  },
  {
    ...
    tagline:
      "Real-time enterprise operational management system for inventory tracking, field-work assignments, and multi-tenant reporting.",
    category: "Enterprise Systems",
    clientOrDomain: "HawkEyes Digital Monitoring Ltd.",
    year: "2024–2026",
    scale: "Enterprise Multi-Tenant • Real-Time Workflows • On-Site Production",
    summary:
      "Designed and engineered responsive enterprise dashboards and operational workflow systems at HawkEyes Digital Monitoring Ltd. Built scalable frontend interfaces for product tracking, inventory management, and field-work assignments with RTK Query and Redux Toolkit.",
    challenge: {
      context:
        "Operational field teams and supervisors required a centralized, real-time dashboard to monitor ongoing digital monitoring tasks, inventory statuses, and field-work assignments without manual tracking overhead or data delays.",
      painPoints: [
    ...
    architecturalSolution: {
      coreApproach:
        "Architected a modular React + Redux Toolkit application with RTK Query caching layers. Built reusable UI state patterns (loading skeletons, error boundaries, empty states) and integrated REST APIs with JWT authentication.",
      keyDecisions: [
        {
          decision: "RTK Query Automated Polling & Cache Invalidation",
          rationale:
            "Configured tag-based cache invalidation and background polling for real-time field-work status, eliminating redundant manual page refreshes.",
          alternativeConsidered:
            "Manual useEffect data fetching was replaced to prevent memory leaks and duplicate requests.",
        },
        {
          decision: "Standardized Compound UI State Components",
          rationale:
            "Created standardized skeleton loaders, error retry panels, and empty state templates, reducing duplicate implementation across 15+ sub-modules.",
          alternativeConsidered:
            "Ad-hoc per-component loading state logic was eliminated for engineering consistency.",
        },
        {
          decision: "Collaborative Frontend-Backend API Contract Design",
          rationale:
            "Partnered with backend engineers on strict API contracts, data normalization, and error payloads before feature implementation.",
          alternativeConsidered:
            "Building frontend against shifting unverified API endpoints was strictly avoided.",
        },
      ],
      diagramSteps: [
        {
    ...
    tradeoffs: [
      {
        accepted:
          "Aggressive polling interval on active assignments consumes higher client battery on low-end devices",
        mitigation:
          "Implemented Page Visibility API to pause polling when dashboard tab is inactive or minimized.",
      },
      {
        accepted: "Complex Redux state slice normalization requires initial setup overhead",
        mitigation:
          "Created standardized slice boilerplates and custom hooks for streamlined feature additions.",
      },
    ],
    metrics: [
      {
        ...
        value: "-45%",
        change: "RTK Query smart caching",
        isPositive: true,
      },
      {
        label: "Workflow Overhead",
        value: "-60%",
        change: "Automated field assignment UI",
        isPositive: true,
      },
      {
        label: "Cross-Device Score",
        value: "100%",
        change: "Mobile, tablet & desktop verified",
        isPositive: true,
      },
      {
        label: "UI State Consistency",
        value: "Zero Glitches",
        change: "Standardized state templates",
        isPositive: true,
      },
    ],
    techStackIds: [
  ...
  },
  {
    ...
    tagline:
      "High-speed, SEO-optimized gym platform built with Next.js App Router, dynamic server rendering, and fluid motion.",
    ...
    summary:
      "Engineered a production-ready gym platform designed for maximum speed, SEO visibility, and smooth interaction. Built using the Next.js App Router with modular components, lazy-loaded media assets, Motion transitions, and server-rendered dynamic sections.",
    liveUrl: "https://forge-fitness.vercel.app",
    githubUrl: "https://github.com/razikuljoni/Forge",
    challenge: {
      context:
        "Modern fitness brands rely heavily on organic search traffic and high conversion rates. Slow mobile load times, heavy media files, and layout shifts directly harm user sign-ups and Google search rankings.",
      painPoints: [
    ...
    architecturalSolution: {
      coreApproach:
        "Leveraged Next.js App Router with React Server Components (RSC) to minimize client JavaScript bundle size. Configured next/image optimization, responsive modern typography, and Motion micro-animations.",
      keyDecisions: [
        {
          decision: "Next.js App Router & Server Component Architecture",
          rationale:
            "Rendered marketing sections, training programs, and schedule tables on the server, sending zero unnecessary JavaScript to the client.",
          alternativeConsidered:
            "Client-side SPA was rejected due to SEO limitations and larger bundle size.",
        },
        {
          decision: "Adaptive Media Loading & Next/Image Optimization",
          rationale:
            "Served modern WebP/AVIF formats with exact srcSet responsive dimensions and blur placeholder placeholders, eliminating Cumulative Layout Shift (CLS).",
        ...
        },
        {
          ...
          rationale:
            "Created smooth scroll-triggered entry transitions and interactive pricing cards that render at 60 FPS without layout thrashing.",
          alternativeConsidered:
            "Heavy CSS keyframe libraries were replaced with GPU-accelerated Motion transforms.",
        },
      ],
      diagramSteps: [
        {
    ...
    tradeoffs: [
      {
        accepted:
          "Server-side rendering introduces small initial compute time on cache misses (~25ms)",
        mitigation:
          "Enabled Incremental Static Regeneration (ISR) to cache generated pages at edge nodes.",
      },
      {
        accepted:
          "Strict component splitting into Server and Client components requires disciplined code architecture",
        mitigation:
          'Maintained strict file naming conventions and modular "use client" leaf boundaries.',
      },
    ],
    metrics: [
      {
        ...
        value: "98/100",
        change: "Near-perfect performance score",
        isPositive: true,
      },
      {
        label: "Largest Contentful Paint",
        value: "0.9s",
        change: "Sub-second mobile LCP",
        isPositive: true,
      },
      {
        label: "Cumulative Layout Shift",
        value: "0.00",
        change: "Zero visual jank or jumps",
        isPositive: true,
      },
      {
        label: "SEO Visibility",
        value: "100%",
        change: "Dynamic OpenGraph & meta tags",
        isPositive: true,
      },
    ],
  ...
  },
  {
    ...
    tagline:
      "Interactive frontend analytics dashboard featuring dynamic routing, reusable modular panels, ECharts, and Google Maps.",
    category: "Data Visualization",
    clientOrDomain: "Analytics & Geospatial Intelligence",
    year: "2024–2025",
    scale: "Modular Workspace • Multi-Chart Layouts • Geospatial Views",
    summary:
      "Engineered a highly flexible data visualization dashboard in React featuring dynamic routing, multiple chart configurations, geospatial device tracking with Google Maps API, and scalable Redux state management.",
    liveUrl: "https://dashboard-wizard.vercel.app",
    githubUrl: "https://github.com/razikuljoni/Dashboard-Wizard",
    challenge: {
      context:
        "Analytics operators and business managers need to visualize diverse data streams (time-series revenue, regional device distributions, comparative metrics) in a customizable and responsive workspace.",
      painPoints: [
    ...
    architecturalSolution: {
      coreApproach:
        "Architected a modular panel system using React, Redux, and Apache ECharts. Built a unified filter state bus that propagates temporal and geographic range selections to all child visualization cards synchronously.",
      keyDecisions: [
        {
          decision: "Unified Redux Filter State Hub",
          rationale:
            "Centralized active date ranges, category filters, and geographic bounding boxes into a normalized Redux slice, ensuring all chart widgets stay strictly synchronized.",
          alternativeConsidered:
            "Passing filter props through deep component trees created prop-drilling headaches.",
        },
        {
          decision: "ECharts Responsive Wrapper with ResizeObserver",
          rationale:
            "Encapsulated Apache ECharts inside a custom React wrapper that listens to container dimension changes via ResizeObserver, preventing chart distortion on panel resize.",
          alternativeConsidered:
            "Fixed pixel dimensions caused overflow and layout breakage on responsive screens.",
        },
        {
          decision: "Google Maps Geospatial Marker Clustering",
          rationale:
            "Integrated Google Maps API with marker clustering algorithms to render hundreds of device locations without slowing down map pan/zoom operations.",
    ...
    tradeoffs: [
      {
        ...
        mitigation:
          "Used dynamic imports to code-split visualization engines and load them on demand.",
      },
      {
        accepted: "Google Maps API requires external script loading and API key management",
        mitigation:
          "Created an asynchronous script loader with graceful fallback states if the network is restricted.",
      },
    ],
    metrics: [
      {
        ...
        value: "< 16ms",
        change: "60 FPS smooth interactions",
        isPositive: true,
      },
      {
        label: "Layout Archetypes",
        value: "6+ Layouts",
        change: "Grid, flex, split & full-screen",
        isPositive: true,
      },
      {
        label: "Filter Sync Time",
        value: "Instant",
        change: "Zero state lag across panels",
        isPositive: true,
      },
      {
        label: "Geospatial Markers",
        value: "1,000+ Clustered",
        change: "Smooth map pan & zoom",
        isPositive: true,
      },
    ],
  ...
  },
  {
    ...
    tagline:
      "Developer tooling ecosystem comprising 11 cohesive dark themes, 390+ file/folder icons, and productivity snippets with automated CI/CD.",
    category: "Developer Tooling",
    clientOrDomain: "Developer Experience & Open Source",
    year: "2024–2025",
    scale: "11 Themes • 390+ Custom Icons • Automated GitHub Actions",
    summary:
      "Built and published OpenPalette, a developer tooling suite for VS Code featuring 11 cohesive dark themes, 300+ file icons, 90+ folder icons, and productivity snippets for JavaScript, TypeScript, and React. Built automated CI/CD release workflows with GitHub Actions.",
    liveUrl: "https://marketplace.visualstudio.com",
    githubUrl: "https://github.com/razikuljoni/OpenPalette",
    challenge: {
      context:
        "Software developers spend hours daily in code editors where visual clutter, inconsistent syntax highlighting, and generic icons cause eye strain and decrease file navigation speed.",
      painPoints: [
    ...
    architecturalSolution: {
      coreApproach:
        "Architected a modular token generation system using TypeScript and JSON schemas. Built automated release pipelines using GitHub Actions, Standard Version, and VSCE for seamless multi-package deployment.",
      keyDecisions: [
        {
          decision: "Semantic Color Token Architecture",
          rationale:
            "Created a centralized palette dictionary that generates syntax token definitions across 11 themes with guaranteed optical luminance contrast.",
          alternativeConsidered:
            "Manually editing 11 separate 2,000-line JSON files was rejected due to maintenance overhead.",
        },
        {
          decision: "Comprehensive Icon Association Hierarchy",
          rationale:
            "Mapped 300+ file extensions and 90+ folder naming conventions (e.g. .graphql, .dockerfile, /adapters, /controllers) to custom SVG icon sets.",
          alternativeConsidered:
            "Generic icon fallbacks were minimized to provide instant visual recognition for modern full-stack stacks.",
        },
        {
          decision: "Automated CI/CD Release with Standard Version",
          rationale:
            "Configured GitHub Actions workflows that automatically bump semantic versions, generate changelogs, tag Git commits, and publish extension artifacts.",
          alternativeConsidered:
            "Manual terminal publishing was replaced with deterministic pipeline releases.",
        },
      ],
      diagramSteps: [
        {
    ...
    tradeoffs: [
      {
        ...
        mitigation:
          "Automated SVG minification pipeline to keep extension install bundle under 2MB.",
      },
      {
        accepted:
          "Deep TextMate scope customization requires testing against various language grammars",
        mitigation:
          "Created automated syntax snapshot tests across TypeScript, Python, Go, and Rust samples.",
      },
    ],
    metrics: [
      {
        label: "Editor Themes",
        value: "11 Cohesive",
        change: "Dark mode variations",
        isPositive: true,
      },
      {
        label: "Custom Icons",
        value: "390+ Icons",
        change: "300+ files, 90+ folders",
        isPositive: true,
      },
      {
        label: "Release Automation",
        value: "100% CI/CD",
        change: "GitHub Actions & Standard Version",
        isPositive: true,
      },
      {
        label: "Snippets Shipped",
        value: "50+ Snippets",
        change: "React, Next.js, Express & TS",
        isPositive: true,
      },
    ],
...
export const ARCHITECTURE_TENETS: ArchitectureTenet[] = [
  {
    ...
    description:
      "Never mix ephemeral server cache with persistent client store. Leverage RTK Query and TanStack Query with normalized cache keys and automated tag invalidation for server data, while keeping client-side state minimal, focused, and predictable with tools like Zustand or Redux slices.",
    ruleOfThumb:
      "If a component re-fetches data that is already fresh in cache or triggers redundant network requests, your state boundaries need refactoring.",
  },
  {
    id: "tenet-2",
    number: "02",
    ...
    description:
      "Runtime validation must strictly guard all external inputs using Zod schemas at controller and form boundaries. Once parsed and validated, strong TypeScript type inference flows seamlessly through services, hooks, and presentation components with zero unsafe type assertions.",
    ruleOfThumb:
      'Never use "any" or unvalidated type casts on incoming API payloads or user form submissions.',
  },
  {
    id: "tenet-3",
    number: "03",
    ...
    description:
      "Optimize user perceived latency by combining server-side rendering (SSR), image format optimization (WebP/AVIF), lazy-loaded component chunks, and CSS containment. Eliminate layout shifts (CLS) by giving all media explicit aspect ratios and skeleton placeholders.",
    ruleOfThumb:
      "A production web app should deliver a sub-1.2s Largest Contentful Paint (LCP) and zero layout shift on standard 4G mobile devices.",
  },
  {
    id: "tenet-4",
    number: "04",
    ...
    description:
      "Standardize compound components for complex patterns (data tables, modal dialogs, loading skeletons, error boundaries). Ensure WCAG AA color contrast, responsive typography math, accessible keyboard navigation, and seamless behavior across desktop, tablet, and mobile.",
    ruleOfThumb:
      "Every async UI screen must handle loading, success, empty, and error states gracefully with accessible retry mechanisms.",
  },
];
...
export const EDUCATION_ITEMS: EducationItem[] = [
  {
    ...
    notes:
      "Undergraduate coursework focusing on Data Structures, Algorithms, Object-Oriented Programming, Database Management Systems, and Software Engineering principles.",
  },
  {
    id: "edu-2",
    ...
    location: "Dhaka, Bangladesh",
    notes:
      "Science background with coursework in Mathematics, Physics, Chemistry, and Information Technology.",
  },
];
