...
const principles = [
  [
    ...
    "Good interfaces reveal the system without making people study it.",
  ],
  [
    "02",
    "Design for change",
    "Reusable components and clear boundaries beat a clever one-off every time.",
  ],
  [
    "03",
    "Performance is product",
    "Fast, stable, accessible software is not polish—it is the experience.",
  ],
  [
    "04",
    "Own the handoff",
    "A feature is not finished until the API contract, edge cases, and deployment story make sense.",
  ],
];
...
const capabilities = [
  {
    name: "React / Next.js",
    level: "Primary",
    detail: "App Router, RSC, component systems, SSR, performance",
  },
  {
    name: "JavaScript / TypeScript",
    level: "Primary",
    detail: "Modern language patterns, async systems, safe refactoring",
  },
  {
    name: "State & data",
    level: "Advanced",
    detail: "Redux Toolkit, RTK Query, TanStack Query, Zustand",
  },
  {
    name: "Node / Express",
    level: "Advanced",
    detail: "REST APIs, middleware, authentication, validation",
  },
  {
    name: "NestJS",
    level: "Growing",
    detail: "Modules, services, guards, scalable backend structure",
  },
  { name: "Data systems", level: "Working", detail: "MongoDB, PostgreSQL, MySQL, schema thinking" },
  {
    name: "Interface craft",
    level: "Primary",
    detail: "Tailwind, Ant Design, responsive UI, accessibility",
  },
  {
    name: "Delivery",
    level: "Working",
    detail: "Docker, GitHub Actions, Vercel, CI/CD foundations",
  },
];
  ...
  return (
    <>
      ...
      <main id="main-content" tabIndex={-1}>
        <section className="hero" id="top">
          ...
          <div className="hero-main">
            <p className="hero-kicker">
              <i /> Product-minded full-stack developer
            </p>
            <h1>
            ...
            <div className="hero-intro">
              <p>
                Two years inside real operational software taught me that the best interface is not
                the loudest one. It is the one that makes a complex workflow feel inevitable.
              </p>
          ...
          <div className="portrait-stage">
            ...
            <span className="portrait-caption">
              Dhaka, Bangladesh / Available for full-stack roles / Onsite or Remote
            </span>
            <div className="portrait-note note-one">
              <small>Current edge</small>
              <strong>Frontend depth</strong>
              <span>React · Next · Systems UI</span>
            </div>
            <div className="portrait-note note-two">
              <small>Building next</small>
              <strong>Backend range</strong>
              <span>NestJS · ExpressJS · MongoDB</span>
            </div>
            <SparkMark />
          </div>
          ...
          <div className="signal-strip">
            <div>
              <strong>02+</strong>
              <span>Years in production teams</span>
            </div>
            <div>
              <strong>123</strong>
            ...
            <div>
              <strong>11</strong>
              <span>Editor themes shipped in OpenPalette</span>
            </div>
            <div>
              <strong>390+</strong>
              <span>File and folder icons curated</span>
            </div>
          </div>
        </section>
        ...
        <section className="manifesto section-wrap" id="profile">
          ...
          <div className="manifesto-copy">
            <p className="oversized-copy">
              Frontend specialist by experience. Full-stack engineer by direction. Product thinker
              by habit.
            </p>
            <div className="manifesto-columns">
              <p>
                I work best where data-heavy workflows, reusable interface systems, and real
                business constraints meet. My recent work spans enterprise dashboards, inventory and
                product tracking, field-work assignment, reporting, role-based access, and
                API-driven operations.
              </p>
              <p>
                I care about the details users feel but rarely name: immediate feedback, predictable
                state, useful empty screens, resilient loading behavior, keyboard access, and code
                another developer can safely extend.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="project-section" id="projects">
          <div className="project-heading section-wrap">
            ...
            <p className="heading-note">
              Each case notes the problem, the system, and the decisions—not just the technology
              badges.
            </p>
          </div>
        ...
        <section className="experience-section section-wrap" id="experience">
          ...
          <div className="experience-content">
            ...
            <div className="experience-story">
              <p className="lead">
                Built the operational surfaces behind real business monitoring—where a small UI
                mistake can become a very large workflow problem.
              </p>
              <div className="experience-grid">
                <div>
                  ...
                  <p>
                    Responsive enterprise dashboards, inventory systems, product tracking,
                    reporting, and real-time field-work assignment interfaces.
                  </p>
                </div>
                <div>
                  <span>02</span>
                  ...
                  <p>
                    REST API integration, JWT and role-based access, reusable query flows, Redux
                    Toolkit, and RTK Query for complex application state.
                  </p>
                </div>
                <div>
                  <span>03</span>
                  <h3>Cross-team delivery</h3>
                  <p>
                    Partnered with backend engineers on API contracts, frontend data models, edge
                    cases, Git workflows, and Vercel-based delivery.
                  </p>
                </div>
                <div>
                  <span>04</span>
                  <h3>Quality work</h3>
                  <p>
                    Improved responsiveness, accessibility, maintainability, and performance across
                    data-intensive interfaces and multiple viewports.
                  </p>
                </div>
              </div>
        ...
        <section className="capabilities-section" id="capabilities">
          <div className="capabilities-head section-wrap">
            ...
            <div>
              <p className="eyebrow">A working system, not a logo cloud</p>
              <h2>
                Tools with
                <br />
                <em>context.</em>
        ...
        <section className="lab-section section-wrap">
          ...
          <div className="lab-content">
            <div className="lab-heading">
              ...
              <a
                href="https://github.com/razikuljoni?tab=repositories"
                target="_blank"
                rel="noreferrer"
              >
                Browse all 123 repositories <Arrow diagonal />
              </a>
            </div>
        ...
        <section className="profile-section section-wrap">
          ...
          <div className="background-grid">
            <div className="education-block">
              ...
              <div>
                <span>2020—2023</span>
                <h3>Computer Science & Engineering studies</h3>
                <p>Green University of Bangladesh</p>
              </div>
              <div>
                <span>2018—2019</span>
                <h3>Higher Secondary Certificate · Science</h3>
                <p>Vashantek Government College</p>
              </div>
              <div>
                <span>Completed</span>
                <h3>Web Development & Next Level Web Development</h3>
                <p>Programming Hero · both tracks</p>
              </div>
            </div>
            <div className="offclock-block">
              ...
              <p>
                Music for focus. Movies for new perspectives. Long walks, open air, and new places
                for the reset button. Curiosity travels well between code and everything else.
              </p>
              <div>
        ...
        <section className="closing" id="contact">
          ...
          <h2>
            ...
            <br />
            <em>I&apos;ll bring the clarity.</em>
          </h2>
          <div className="contact-actions">
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=razikuljoni@gmail.com&su=Let%27s%20work%20together"
              target="_blank"
              rel="noreferrer"
            >
              Write an email <Arrow diagonal />
            </a>
            <a href="https://cal.com/razikuljoni/15min" target="_blank" rel="noreferrer">
              Book a 15 min call <Arrow diagonal />
            </a>
          </div>
      ...
      <footer>
        ...
        <div>
          <Link href="/resume">Résumé</Link>
          <a href="https://github.com/razikuljoni" target="_blank" rel="noreferrer">
            GitHub
          </a>
          <a href="https://www.linkedin.com/in/razikuljoni" target="_blank" rel="noreferrer">
            LinkedIn
          </a>
          <a href="https://x.com/razikuljoni" target="_blank" rel="noreferrer">
            X
          </a>
          <a href="https://cal.com/razikuljoni/15min" target="_blank" rel="noreferrer">
            15 min call
