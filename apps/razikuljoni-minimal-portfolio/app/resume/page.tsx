            ...
            <article className="resume-page">
                <header className="resume-header">
                    <div className="resume-intro">
                        ...
                        <p className="summary">
                            Product-minded full-stack developer with 2+ years of professional
                            experience translating complex operations into fast, accessible web
                            products. Strongest in React and Next.js interface systems, API
                            integration, state architecture, and data-heavy dashboards; expanding
                            backend depth with Node.js, Express, and NestJS.
                        </p>
                    </div>
                    ...
                    <address aria-label="Contact details">
                        ...
                        <ExternalLink href="https://github.com/razikuljoni">
                            GitHub / razikuljoni
                        </ExternalLink>
                    ...
                    <div className="resume-main">
                        <section>
                            ...
                            <div className="resume-role">
                                ...
                                <ul>
                                    <li>
                                        Designed and delivered responsive enterprise dashboards,
                                        operational workflow systems, inventory management, product
                                        tracking, reporting, and field-work assignment interfaces.
                                    </li>
                                    <li>
                                        Integrated REST APIs and real-time data flows with JWT
                                        authentication, role-based access control, Redux Toolkit,
                                        and RTK Query across data-intensive applications.
                                    </li>
                                    <li>
                                        Built reusable UI and state patterns that reduced duplicate
                                        implementation and made complex loading, error, empty, and
                                        permission states predictable.
                                    </li>
                                    <li>
                                        Partnered with backend engineers on API contracts, frontend
                                        data models, validation rules, edge cases, Git workflows,
                                        and Vercel delivery.
                                    </li>
                                    <li>
                                        Improved performance, accessibility, maintainability, and
