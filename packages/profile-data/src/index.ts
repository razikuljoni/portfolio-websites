...
export const EXPERIENCES: ExperienceItem[] = [
  ...
  },
  {
    ...
    summary:
      "Building full-stack web applications, performance-first platforms, modular data visualization dashboards, and developer tooling packages.",
    highlights: [
...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    description:
      "Full-stack Big-scale e-commerce platform with smart recommendations, real-time inventory, live order tracking, multi-currency localization, 2FA security, customer analytics, and seller management.",
    category: "fullstack",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Production-grade IoT platform for connecting physical devices, receiving realtime sensor telemetry, historical data visualization, remote device control, automation workflows, and alert monitoring.",
    category: "fullstack",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Micro-frontend monorepo built with React 19, TypeScript, Vite Module Federation, Three.js, and Tailwind CSS for modular graphics-heavy web applications.",
    category: "frontend",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "High-converting luxury hotel and resort booking platform with real-time availability, dynamic pricing, curated travel experiences, itinerary management, and an AI luxury concierge.",
    category: "fullstack",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Swiss-inspired luxury real estate platform featuring curated modern architectural residences, interactive property portfolios, mortgage calculators, and neighborhood guides.",
    category: "frontend",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Fast, customizable, and AI-powered .gitignore generator supporting 120+ stacks, frameworks, operating systems, and IDEs.",
    category: "tooling",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Curated collection of 56+ production-ready CSS effects with live previews, filter tags, and one-click copy for UI designers and developers.",
    category: "frontend",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Full-stack monochromatic e-commerce platform with real-time inventory, secure checkout, 2FA, seller admin dashboard, personalized AI recommendations, offline sync, and order tracking.",
    category: "fullstack",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Corporate and trial legal counsel platform specializing in mergers and acquisitions, high-stakes commercial litigation, IP, and regulatory compliance.",
    category: "frontend",
    isFeatured: true,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Encrypted note taking and knowledge vault featuring AI smart linking, vector graph exploration, and distraction-free markdown editing.",
    category: "fullstack",
    isFeatured: false,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Automated project analysis tool for analyzing repo structure, dependency graphs, LOC metrics, and architectural health.",
    category: "tooling",
    isFeatured: false,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Real-time automation engine handling pub/sub webhooks, event orchestration, and scheduled workflow execution.",
    category: "backend",
    isFeatured: false,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Mobile railway navigation and ticketing application providing real-time train tracking, schedule lookup, and seat reservations.",
    category: "mobile",
    isFeatured: false,
    isRecent: true,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Modular NestJS backend application with MongoDB Mongoose integration, Swagger REST docs, and JWT authentication.",
    category: "backend",
    isFeatured: false,
    isRecent: false,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Node.js & Express REST API for cattle marketplace featuring Zod validation, JWT authentication, and buyer/seller transaction flows.",
    category: "backend",
    isFeatured: false,
    isRecent: false,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Ecosystem of 11 dark VS Code themes and 390+ custom SVG file icons built for developer aesthetic and focus.",
    category: "tooling",
    isFeatured: false,
    isRecent: false,
    stars: 0,
  ...
  },
  {
    ...
    description:
      "Full-stack MERN application for exploring books, maintaining personal reading wishlists, submitting reviews, and managing collections.",
    category: "fullstack",
    isFeatured: false,
    isRecent: false,
    stars: 0,
